...
function Addproject(props) {
    ...
    return (
        ...
        <div class="project-container">
            ...
            <Input type="text" id="project_name" placeholder="Project Name" maxLength='30' classfield="project-inputField" onChange={(e) => setProjectName(e.target.value)} />
            <textarea rows="6" placeholder="Describe the project here..." maxLength={150} form="usrform" className='project-description'
