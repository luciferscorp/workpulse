...
const Pagination = () => {
    ...
    async function updateEmpFunction(empid) {
        try {
            const updateUserData = { isactivate: activeIsActive , UpdatedOn : UpdateOn , EmployeeID: empid }
    ...
    return (
        <>
            <div className="emp-bodycontainer">
                <div className='emp-tablecontainer'><h4 className='pagination-heading' >Employee Details</h4>
