    ...
    <div>
      <div class="regcontainer">
        <form name="registrationForm" method="get">
          ...
          <div>
            <Input type="text" id="companyName" placeholder="Company Name" maxLength='20' classfield="inputField" onChange={(e) => setCompanyName(e.target.value)} />
          </div>
          <span className='spanEnd' id='error'>{error}</span>
          <div className='AddCompany-Button'>
            <Button type="button" Title="Submit" classfield={"greenSubmitButton"} onClick={CompanyValidation} />
          </div>
        </form>
      </div >
    </div >
