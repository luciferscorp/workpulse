...
const ProjectPagination = () => {
    ...
    let prjcurrentDateRaw = new Date()
    let prjupdateDate = prjcurrentDateRaw.toISOString().split('T')[0].split("-").reverse().join("/");
    ...
    return (
        <>
            <div className="prj-bodycontainer">
                <div className='prj-tablecontainer'><h4 className='ProjectPagination-heading' >Project Details</h4>
                                ...
                                <tr className='prj-tablerow' key={i}>
                                    ...
                                    <td className='prj-tabledata'>
                                        ...
                                        {hide && ArrayData.ProjectID === activeProjectId && (
                                            <input
                                                defaultValue={ArrayData.ProjectName}
                                    ...
                                    <td className=' prj-description'>
                                        ...
                                        {hide && ArrayData.ProjectID === activeProjectId && (
                                            <input
                                                defaultValue={ArrayData.Description}
                                    ...
                                    <td className='cmp-tabledata'>
                                        ...
                                        <DeleteIcon sx={{ cursor: "pointer" ,marginLeft:"10px" }} onClick={() => {
