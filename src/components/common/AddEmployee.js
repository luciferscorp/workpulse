  ...
  return (
    ...
    <div class="empolyee-regcontainer">
      ...
      <div className='divison'>
        ...
        <Input type="text" id="userName" placeholder="Employee Name" maxLength='25' classfield="employee-inputField" onChange={(e) => setUserName(e.target.value)} />

        <Input type="email" id="email" placeholder="Email" maxLength='35' classfield="email-inputField" onChange={(e) => setEmail(e.target.value)} />

        <Input type="password" id="password" placeholder="Password" maxLength='30' classfield="pass-inputField" onChange={(e) => setPassword(e.target.value)} />

        <Input type="password" id="re_Password" placeholder="Confirm Password" maxLength='30' classfield="cnf-pass-inputField" onChange={(e) => setRe_Password(e.target.value)} />
      ...
      <div>
        <Input type="date" id="join_date" placeholder="Joining Date" classfield="registerdateField" onChange={(e) => setDate(convertString(e.target.value))} required />
      </div>
